...
while (condition) {
    ...
    if (user_choice.asking_users_choice === "To Update Task") {
        ...
        let user_updated_Value = await inquirer.prompt({
            ...
            type: "input",
            name: "updatedValue",
            message: chalk.yellowBright("Enter the updated value for '" + user_update_items.updateItem + "':"), //The message displayed to the user includes the name of the task they want to update, followed by a colon to indicate where the user should input their updated value.
        });
